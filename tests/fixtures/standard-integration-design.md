...
- webhook endpoint automation with `clink webhook endpoint ensure --events commerce --save-secret --json`, signing-secret sync, restart or redeploy, and backend verification
